...
function buildMoviesSection(list, categoryName){
    ...
    const moviesListHTML = list.map(item => {
        return `
        <div class="movie-card" onmouseenter="searchMovieTrailer('${item.title}', 'yt${item.id}')">
            <img class="move-card-img" src="${imgPath}${item.backdrop_path}" alt="${item.title}" />
...
document.getElementById('vpn-popup-close').addEventListener('click', function() {
    document.getElementById('vpn-popup').classList.add('hidden');
});